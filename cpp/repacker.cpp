...
public:
    ...
    bool canPlant(const Rectangle& rect, int xMax, int yMax)
    {
        // Mind the gap.
        char s = shape();
        if (s == 'T')
    ...
    double slotFillRate(const Rectangle& rect)
    {
...
public:
    ...
    Corner *
    walkFindBest(const Rectangle& rect)
    {
...
bool compRectangle(const Rectangle& r1, const Rectangle& r2)
{
    return
...
int writeRectangles(std::vector<Rectangle*> rs,
